...
const uniqueColumns = ga4.normalizedDeviceUniqueColumns;

publish("normalized_device_type", {
  type: "incremental",
...
SELECT GENERATE_UUID() as normalized_device_type_id, source.*, CURRENT_TIMESTAMP() as created_ts FROM source
